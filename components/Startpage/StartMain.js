                    ...
                    <div className='text-about-us-container'>
                        <div>
                            ...
                            <div className="about-us-text">
                                ...
                                It does its magic over the interface of a map, where you can see all other logged on
                                students. It lets you interact,
                                so you can be there for each other, one as a student tutor, and the other as a helpee.
                                If the tutoring
                                is satisfactory, the helpee may choose to commend his tutor, this improves the tutor's
                                rating.
                            </div>

                            <div className='about-us-position'>
                                <button className='button-about-us' onClick={() => setAboutUsPopUp(true)}>ABOUT US
                                </button>
                            </div>
                        </div>
                    </div>
